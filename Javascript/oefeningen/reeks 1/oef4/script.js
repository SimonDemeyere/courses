...
while (verschilJaren < 0) {
    console.log("Opgegeven leeftijd is jonger dan 0. Probeer opnieuw.")
    geboorteJaar = prompt("Geef geboorte jaar in:");
    verschilJaren = huidigJaar - geboorteJaar;
}
